...
object csvConversion {
    def main(args: Array[String]) {
        ...
        val knows = knows_person.map(row => ( "person:" + row.getString(0), Array(new Edge( row.getLong(1), "knows", creationDateFormat.parse(row.getString(2)).getTime() )) ) ).rdd
        ...
        val hasInterest = hasInterest_person.map(row => ( "person:" + row.getString(0), Array(new Edge(row.getLong(1), "hasInterest", 0l)))).rdd
        ...
        val person_isLocatedIn = isLocatedIn_person.map(row => ( "person:" + row.getString(0), Array(new Edge(row.getLong(1), "isLocatedIn", 0l)))).rdd
        ...
        val likes_comment = likes_comment_person.map(row => ( "person:" + row.getString(0), Array(new Edge( row.getLong(1), "likes", creationDateFormat.parse(row.getString(2)).getTime() )) ) ).rdd
        ...
        val likes_post = likes_post_person.map(row => ( "person:" + row.getString(0), Array(new Edge( row.getLong(1), "likes", creationDateFormat.parse(row.getString(2)).getTime() )) ) ).rdd
        ...
        val studyAt = studyAt_person.map(row => ( "person:" + row.getString(0), Array(new Edge( row.getLong(1), "studyAt", row.getString(2).toLong )) ) ).rdd
        ...
        val workAt = workAt_person.map(row => ( "person:" + row.getString(0), Array(new Edge( row.getLong(1), "workAt", row.getString(2).toLong )) ) ).rdd
        ...
        val hasCreator = hasCreator_comment.map(row => ( "comment:" + row.getString(0), Array(new Edge( row.getLong(1), "hasCreator", 0l )))).rdd
        ...
        val hasTag =  hasTag_comment.map(row => ( "comment:" + row.getString(0), Array(new Edge( row.getLong(1), "hasTag", 0l )))).rdd
        ...
        val comment_isLocatedIn =  isLocatedIn_comment.map(row => ( "comment:" + row.getString(0), Array(new Edge( row.getLong(1), "isLocatedIn", 0l )))).rdd
        ...
        val replyOf_comment =  replyOf_comment_comment.map(row => ( "comment:" + row.getString(0), Array(new Edge( row.getLong(1), "replyOf", 0l )))).rdd
        ...
        val replyOf_post = replyOf_post_comment.map(row => ( "comment:" + row.getString(0), Array(new Edge( row.getLong(1), "replyOf", 0l )))).rdd
        ...
        val containerOf = containerOf_forum.map(row => ( "forum:" + row.getString(0), Array(new Edge( row.getLong(1), "containerOf", 0 )))).rdd
        ...
        val hasMemberWithPosts = hasMemberWithPosts_forum.map(row => ( "forum:" + row.getString(0), Array(new Edge( row.getLong(1), "hasMemberWithPosts", creationDateFormat.parse(row.getString(2)).getTime() )) ) ).rdd
        ...
        val hasMember = hasMember_forum.map(row => ( "forum:" + row.getString(0), Array(new Edge( row.getLong(1), "hasMember", creationDateFormat.parse(row.getString(2)).getTime() )) ) ).rdd
        ...
        val hasModerator = hasModerator_forum.map(row => ( "forum:" + row.getString(0), Array(new Edge( row.getLong(1), "hasModerator", 0 )) ) ).rdd
        ...
        val forum_hasTag = hasTag_forum.map(row => ( "forum:" + row.getString(0), Array(new Edge( row.getLong(1), "hasTag", 0 )) ) ).rdd
        ...
        val organisation_isLocatedIn = isLocatedIn_organisation.map(row => ( "organisation:" + row.getString(0), Array(new Edge( row.getLong(1), "isLocatedIn", 0 )) ) ).rdd
        ...
        val post_hasCreator = hasCreator_post.map(row => ( "post:" + row.getString(0), Array(new Edge( row.getLong(1), "hasCreator", 0)) ) ).rdd
        ...
        val post_hasTag = hasTag_post.map(row => ( "post:" + row.getString(0), Array(new Edge( row.getLong(1), "hasTag", 0 )) ) ).rdd
        ...
        val post_isLocatedIn = isLocatedIn_post.map(row => ( "post:" +row.getString(0), Array(new Edge( row.getLong(1), "isLocatedIn", 0 )) ) ).rdd
        ...
        val isPartOf = isPartOf_place.map(row => ( "place:" +row.getString(0), Array(new Edge( row.getLong(1), "isPartOf", 0 )) ) ).rdd
        ...
        val reverse_edge = all_unioned.flatMap(vertex => {
            ...
            neighbours.flatMap(n => Array( (n.target.toString, new Edge(sourceid.toLong, n.elabel, n.creationDate))))
        })
        ...
        //output to file
        val output = flattened.map(r => output_csv_line(r))
